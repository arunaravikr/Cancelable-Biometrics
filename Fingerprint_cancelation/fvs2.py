...
image_path = raw_input("Enter BMP Image File of FingerPrint : ")
yaml_path = raw_input("Enter YAML File of the FingerPrint : ")
...
image_path = 'images/sap.bmp'
yaml_path = 'images/sap.yaml'
ffiles.append({
            'i': 1,
            'j': 1,
            'image': image_path,
...
# Define the number of sets of hashes to generate
num_hashes = 25

# Open the file for writing
with open("database.txt", "w") as f:
    # Generate the sets of hashes
