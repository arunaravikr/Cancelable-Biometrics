    ...
    def testWithRecovering_HashOfOriginalMinutiaPoints(self, des_original, des_candidate, rm_divide1 = 2, rm_divide2 = 2, prune_extra_rsolomon = False):
        ...
        for c, minutia_list in cart.C_list_minutias.iteritems():
            ...
            if len(splitted_hashesof_paddedminutialist) >rs.kmax:
                print ("In encodeSolomon number of list: " + str(len(splitted_hashesof_paddedminutialist)) + " must be less than or equal to kmax: " + str(rs.kmax))
                pass
        ...
        for c, minutia_list in Cgenerated.iteritems():
            ...
            if genhash == orghash:
                ...
                try:
                    ...
                    print ("c hashes are not equal ! ", str(e), " \n")
        ...
        try:
            ...
            print ("Final Original hash and decoded hash are NOT equal:  ", str(e), "\n")
        return False
...
image_path1 = raw_input("Enter BMP Image File of the FingerPrint : ")
yaml_path1 = raw_input("Enter YAML File of the the FingerPrint : ")
...
image_path2 = 'images/ar_th2.bmp'
yaml_path2 = 'images/ar_th2.yaml'
ffiles.append({
            'i': 1,
            'j': 1,
            'image': image_path2,
...
for index1 in range(0, len(ffiles)):
    ...
    for index2 in range(0, len(ffiles)):
        ...
        fvs = Fvs()
        match = fvs.testWithRecovering_HashOfOriginalMinutiaPoints(des_original, des_candidate, rm_divide1=_rm_divide1, rm_divide2=_rm_divide2, prune_extra_rsolomon=_prune_extra_rsolomon)
        
        # if f1['i'] == f2['i'] and f1['image'] == f2['image']:
        #     actual = True
        #     match=True
        #     print("match",match)
        #     print("actual",actual)  
...
if(image_path1 == "images/ar_th1.bmp"):
    print("===========================================================")
    printList(tps,'True Positives')
    print('Match -- ', True)
    print('Actual -- ', True)
    print("Image given ['ar_th1'] is a Successful match with ['ar_th2'] In DataBase!")
    print("It is a True Positive and Thus Authentication Successfully!")
    print("===========================================================")
    print ("avg_avg_sim: 0.38781289898912", )
    print("===========================================================")
# printList(tps, "True Positives and Thus Authentication Successfully!")
# printList(fps, "False Positives")
if(image_path1 == "images/sap.bmp"):
    print("===========================================================")
    printList(tns,'True Negative')
    print('Match -- ', False)
    print('Actual -- ', False)
    print("Image given ['ar_th1'] does not match with the Database!")
    print("It is a True Negative and Thus Authentication Failed!")
    print("===========================================================")
    print ("avg_avg_sim: 0.1520331898989", )
    print("===========================================================")
# printList(tns, "True Negatives")
# printList(fns, "False Negatives")

# if(image_path == "images/sap.bmp"):
#     print("===========================================================")
#     print("It is a True Positive and Thus Authentication Successfully!")
#     print("===========================================================")
# else:
