...
def main1():
    ...
    for i in range(1, 4):
        for j in range(1, 4):
            if i < 10:
                #finputminutia = 'c:/Users/Sheela/fvs/samples/DB3_B/10' + str(i) + '_' + str(j) + '.tif'
                finputminutia = 'images/10' + str(i) + '_' + str(j) + '.tif'
            else:
               #finputminutia = 'c:/Users/Sheela/fvs/samples/DB3_B/1' + str(i) + '_' + str(j) + '.tif'
                finputminutia = 'images/1' + str(i) + '_' + str(j) + '.tif'
            files.append({
                'i': i,
                'j': j,
                'image': finputminutia
    ...
    for file in files:
        ...
        #image_enhanced_loc = "c:/Users/Sheela/fvs/samples/dumps2/" + base_image_name + "_enhanced.gif"
        #image_enhanced_minutiae_loc = "c:/Users/Sheela/fvs/samples/dumps2/" + base_image_name + "_enhanced_minutiaes.png"
        #image_enhanced_minutiae_aligned_loc = "c:/Users/Sheela/fvs/samples/dumps2/" + base_image_name + "_enhanced_minutiaes_aligned.png"


        image_enhanced_loc = "images/" + base_image_name + "_enhanced.gif"
        image_enhanced_minutiae_loc = "images/" + base_image_name + "_enhanced_minutiaes.png"
        image_enhanced_minutiae_aligned_loc = "images/" + base_image_name + "_enhanced_minutiaes_aligned.png"
        ...
        #dumpfilename = "c:/Users/Sheela/fvs/samples/dumps2/" + os.path.basename(file['image']) + ".yaml"
        dumpfilename = "images/" + os.path.basename(file['image']) + ".yaml"
